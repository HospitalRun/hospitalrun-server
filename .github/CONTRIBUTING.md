...
Please note we have a [code of conduct](https://github.com/HospitalRun/hospitalrun-server/blob/master/.github/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
